...
Enusre if using italics there are spaces within words.
...
Improve formatting, enusre if using italics there are spaces within words, remove redundancy, and verify clarity of risks and metrics.
""",
        agent=qa_agent,
